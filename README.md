...
| `/locate mark <name>` / `/locate marks` / `/locate unmark <name>` | save the spot you stand on / list your marks / delete one; every line has click-to-teleport coordinates plus the buttons below, and dying auto-marks `death` |
